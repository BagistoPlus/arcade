    ...
    const rules = [
      {
        ...
        styles: {
          ...
          "border-color": theme("colors.outline", colors.gray[500]),
          ...
          "&:focus": {
            ...
            "--tw-ring-color": theme("colors.primary", colors.blue[600]),
            "--tw-ring-offset-shadow": `var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)`,
            "--tw-ring-shadow": `var(--tw-ring-inset) 0 0 0 calc(1px + var(--tw-ring-offset-width)) var(--tw-ring-color)`,
            "box-shadow": `var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)`,
            "border-color": theme("colors.primary", colors.blue[600]),
          },
        },
      },
      {
        ...
        styles: {
          color: theme("colors.on-surface-variant", colors.gray[500]),
          opacity: "1",
        },
      },
      {
      ...
      },
      {
        ...
        styles: {
          ...
          height: spacing[4],
          width: spacing[4],
          color: theme("colors.primary", colors.blue[600]),
