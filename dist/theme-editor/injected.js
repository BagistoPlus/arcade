...
/***/ "./resources/js/theme-editor/injected.ts":
/*!***********************************************!*\
  !*** ./resources/js/theme-editor/injected.ts ***!
  \***********************************************/
...
/* harmony import */ var _injected__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./injected */ "./resources/js/theme-editor/injected.ts");
  ...
  _createClass(Editor, [{
    ...
    value: function init() {
      ...
      document.querySelectorAll(".arcade-section").forEach(function (section) {
        ...
        section.addEventListener("mouseleave", _this.onSectionBlur.bind(_this, section));
      });
      ...
      (_this$sectionOverlay$4 = this.sectionOverlay.querySelector("#disable")) === null || _this$sectionOverlay$4 === void 0 ? void 0 : _this$sectionOverlay$4.addEventListener("click", this.onDisableActiveSection.bind(this));
    ...
    key: "onDisableActiveSection",
    value: function onDisableActiveSection() {
    ...
    value: function refreshPreviewer(html) {
      ...
      (0,morphdom__WEBPACK_IMPORTED_MODULE_1__["default"])(document.querySelector("body"), htmlDocument.querySelector("body"));
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/theme-editor/injected.ts");
/******/ 	
/******/ })()
;